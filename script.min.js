...
function _getTextShadowCSS() {
    ...
    //let filteredProps = textshadow.props.filter((prop) => prop.visible)
    //console.log(textShadow)

    // let textShadow = textshadow.order.map((index) => {
    //     const prop = filteredProps.props[index]
...
function createElem(id, offsetX, offsetXUnit, offsetY, offsetYUnit, blurRadius, blurRadiusUnit, color, elem) {
    ...
    hide.change(function() {
        if (textshadow.props[id].visible) {
            ...
            // unit1.removeClass("freeze")
            // unit2.removeClass("freeze")
            // unit3.removeClass("freeze")
...
$("#save-preset-btn").click(function() {
    ...
    _importGradientFromLocalStorage(presets.length - 1, presets[presets.length - 1]);
})
