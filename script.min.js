...
function _importTextShadowFromLocalStorage(index, css) {
    ...
    if (css["font-family"]) {
        ...
        fontFamilyNames.push(css["font-family"])
            // Font.load({
            //         google: {
            //             Webfamilies: [css["font-family"]]
            //         }
            //     })
        element.css("font-family", css["font-family"])
    }
...
function _firstload() {
    ...
    const { letterSpacing, wordSpacing, fontWeight } = textshadow
    if (letterSpacing === "normal") {
    ...
    $("#font-weight").val(textshadow.fontWeight)
    $("#font-weight-slider").slider("value", textshadow.fontWeight)
